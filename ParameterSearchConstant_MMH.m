...
for mmhStyle = 2:3
    parfor (Samplings=TotalSamples,4)
        ...
        runningMMH=1;
        myfilename=['MMH_Constant_style_',num2str(mmhStyle),'/Run_',num2str(Samplings), '.mat'];
        ...
        while runningMMH
            ...
            Cy = Candidate(end)-C1-C2; %
        
            ConstantCy=Cy; %0 for conservation, else that is Cy value
...
save(sprintf('MMH_Constant_style_%d/Run_%g.mat',mmhStyle, Samplings),'array','hits','DistanceSimData','j')
end